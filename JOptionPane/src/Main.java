...
public class Main {
	...
	public static void main(String[] args) {
		...
		//JOptionPane.showMessageDialog(null,"This more useless info","Ýnfo",JOptionPane.INFORMATION_MESSAGE);
		//JOptionPane.showMessageDialog(null,"Really ?","Question",JOptionPane.QUESTION_MESSAGE);
		//JOptionPane.showMessageDialog(null,"Your computer has a VÝRUS!!!","Warning",JOptionPane.WARNING_MESSAGE);
		...
		if (name==null) {
			...
			switch(answer) {
				case(0):JOptionPane.showMessageDialog(null,"Whooaaa!!! You can really code "+name.toUpperCase()+" !!!!","EXCÝTÝNG",JOptionPane.WARNING_MESSAGE);break;
